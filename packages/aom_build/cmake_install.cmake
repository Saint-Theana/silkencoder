# Install script for directory: /root/packages/av1
...
file(INSTALL DESTINATION "/usr/local/include/aom" TYPE FILE FILES
    "/root/packages/av1/aom/aom.h"
    "/root/packages/av1/aom/aom_codec.h"
    "/root/packages/av1/aom/aom_frame_buffer.h"
    "/root/packages/av1/aom/aom_image.h"
    "/root/packages/av1/aom/aom_integer.h"
    "/root/packages/av1/aom/aom.h"
    "/root/packages/av1/aom/aom_decoder.h"
    "/root/packages/av1/aom/aomdx.h"
    "/root/packages/av1/aom/aomcx.h"
    "/root/packages/av1/aom/aom_encoder.h"
    )
endif()
...
file(INSTALL DESTINATION "/usr/local/lib/pkgconfig" TYPE FILE FILES "/root/packages/aom_build/aom.pc")
endif()
...
file(INSTALL DESTINATION "/usr/local/lib" TYPE STATIC_LIBRARY FILES "/root/packages/aom_build/libaom.a")
endif()
...
file(INSTALL DESTINATION "/usr/local/bin" TYPE EXECUTABLE FILES "/root/packages/aom_build/aomdec")
  if(EXISTS "$ENV{DESTDIR}/usr/local/bin/aomdec" AND
     NOT IS_SYMLINK "$ENV{DESTDIR}/usr/local/bin/aomdec")
...
file(INSTALL DESTINATION "/usr/local/bin" TYPE EXECUTABLE FILES "/root/packages/aom_build/aomenc")
  if(EXISTS "$ENV{DESTDIR}/usr/local/bin/aomenc" AND
     NOT IS_SYMLINK "$ENV{DESTDIR}/usr/local/bin/aomenc")
    if(CMAKE_INSTALL_DO_STRIP)
...
file(WRITE "/root/packages/aom_build/${CMAKE_INSTALL_MANIFEST}"
     "${CMAKE_INSTALL_MANIFEST_CONTENT}")
