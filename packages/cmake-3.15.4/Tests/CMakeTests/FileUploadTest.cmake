file(REMOVE_RECURSE "/root/packages/cmake-3.15.4/Tests/CMakeTests/uploads")

if(EXISTS "/root/packages/cmake-3.15.4/Tests/CMakeTests/uploads/file1.png")
  message(FATAL_ERROR "error: file1.png exists - should have been deleted")
endif()
if(EXISTS "/root/packages/cmake-3.15.4/Tests/CMakeTests/uploads/file2.png")
  message(FATAL_ERROR "error: file2.png exists - should have been deleted")
endif()

file(MAKE_DIRECTORY "/root/packages/cmake-3.15.4/Tests/CMakeTests/uploads")

set(filename "/root/packages/cmake-3.15.4/Tests/CMakeTests/FileDownloadInput.png")
if(NOT "/root/packages/cmake-3.15.4/Tests/CMakeTests" MATCHES "^/")
  set(slash /)
endif()
set(urlbase "file://${slash}/root/packages/cmake-3.15.4/Tests/CMakeTests/uploads")
...
execute_process(COMMAND ${CMAKE_COMMAND} -E md5sum
  "/root/packages/cmake-3.15.4/Tests/CMakeTests/uploads/file1.png"
...
execute_process(COMMAND ${CMAKE_COMMAND} -E md5sum
  "/root/packages/cmake-3.15.4/Tests/CMakeTests/uploads/file2.png"
